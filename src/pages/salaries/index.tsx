...
import { getSalaries, deleteSalaryById } from 'apiSdk/salaries';
...
export function SalaryListPage(props: SalaryListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<SalaryInterface>>(
    () => `/salaries?params=${JSON.stringify(params)}`,
    fetcher,
  );
