...
export function EmployeeListPage(props: EmployeeListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getEmployees({
        relations: ['user', 'attendance.count', 'salary.count', 'schedule.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('attendance', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('salary', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'salary',
          header: 'Salary',
          accessorKey: 'salary',
          cell: ({ row: { original: record } }: any) => record?._count?.salary,
        }
      : null,
